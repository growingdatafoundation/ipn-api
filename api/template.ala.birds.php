...
<div class="item-title">Bird sightings within <?php echo $rad.'km'; ?> radius of your <a href="<?php echo \Api\Utils::googleMapsUri($lat, $lon) ?>" target="_blank">location.</a></div>
...
foreach ($responseDetails->facetResults[1]->fieldResult as $value) {
    ...
    $itemResponse = $curl->get(
        'http://bie.ala.org.au/ws/search.json', 
        array(
            'q' => $taxon_name, 
            'fq' => 'kingdom:ANIMALIA'
        )
    ...
    $itemResponse = $itemResponse->body;
